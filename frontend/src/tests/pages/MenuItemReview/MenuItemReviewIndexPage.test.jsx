...
describe("MenuItemReviewIndexPage tests", () => {
  ...
  test("renders three menu item reviews correctly for regular user", async () => {
    ...
    const reviewerEmail = screen.getByText("lilchungus@ucsb.edu");
    expect(reviewerEmail).toBeInTheDocument();

    const comments = screen.getByText("It was alright, nothing special");
  ...
  test("what happens when you click delete, admin", async () => {
    ...
    axiosMock
      ...
      .reply(200, "Menu Item Review with id 2 was deleted");
    ...
    await waitFor(() => {
      expect(mockToast).toBeCalledWith(
        "Menu Item Review with id 2 was deleted",
      );
    });
